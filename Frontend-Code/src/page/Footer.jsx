            ...
            <section class="">
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                  <h5 class="text-uppercase text-color">Turf Booking System</h5>
            ...
            <section class="">
              <p class="d-flex justify-content-center align-items-center">
                ...
                <Link to="/user/login" class="active">
                  <button type="button" class="btn btn-outline-light btn-rounded bg-color custom-bg-text">Log in</button>
                </Link>
              </p>
            </section>
